...
public class Ex02Student {
	public static void main(String[] args) {
		...
		System.out.println("s.calculateSum(): " + s.caluclateSum());
		...
		System.out.println("s2.calculateSum(): " + s2.caluclateSum());

		Student s3 = null;
		s3 = new Student();
		System.out.println("s.3 calculateSum(): " + s3.caluclateSum());
