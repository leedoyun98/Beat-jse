...
public class BoardViewer {
    ...
    public void showBoardMenu() {    	
    	...
    	while(logInUser != null) {
            String message = "1. 새글 작성 2. 글 목록 보기 3. 처음 화면";
    ...
    private void printList() {
        ...
        if(boardList.isEmpty()) {
            ...
            for(BoardDTO b : boardList) {
                System.out.printf("%d. %s  \t작성자:%s\n", b.getId(), b.getTitle(),userViewer.selectNickname(b.getWriterId()));
            }
    ...
    private void printOne(int id) {
        ...
        if(b == null) {
            ...
            System.out.println("작성자: "+userViewer.selectNickname(b.getWriterId()));
      ...
      replyViewer.printAll(b.getId(), userViewer);
            ...
            message = "1. 수정 2. 삭제 3. 댓글다기 4. 목록으로";
