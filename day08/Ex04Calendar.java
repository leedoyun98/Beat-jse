...
// 시간의 차이를 계산할때는 Charonicle을 사용하는 것을 권장하고 있다.

// Calendar의 경우에는
// 1970년 1월 1일 부터 지금까지 혹은 사용자가 설정한 시간까지 
// 1/1000 초 단위로 계산한다.
// 그것을 기반으로 해서 여러가지 값을 보여주거나
